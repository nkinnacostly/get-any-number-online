        ...
        <section className="relative pt-20 pb-32">
          <div className="container mx-auto px-4">
            <div className="text-center max-w-4xl mx-auto relative">
              ...
              >
                <motion.div
                  className="w-24 h-24 bg-card rounded-2xl shadow-2xl flex items-center justify-center relative border border-border"
                ...
                >
                  <div className="grid grid-cols-2 gap-2">
                    ...
                    ></motion.div>
                    <motion.div
                      className="w-6 h-6 bg-muted-foreground rounded-lg"
                      initial={{ opacity: 0 }}
                      animate={{ opacity: 1 }}
              ...
              >
                ...
                >
                  <Button
                    size="lg"
                    variant="outline"
                    className="px-8 py-4 text-lg font-semibold border-2 border-border text-foreground hover:bg-muted rounded-xl transition-all duration-300"
                    asChild
                  >
